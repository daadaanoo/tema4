...
public class NDD_JAVA_tema4 {  // РАБОТА С XML-ФАЙЛАМИ
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Task: Если в таблице сумма значений не равна нулю, то уменьшить максимальный элемент таблицы в два раза, а минимальный элемент уменьшить в три раза");
        ...
        m[maxi][maxj] = m[maxi][maxj] / 2;
        m[mini][minj] = m[mini][minj] / 3;
